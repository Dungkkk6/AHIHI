...
root.iconbitmap(r'G:\python\translate\logo.ico')

load = Image.open(r'G:\python\translate\background.png')
...
def translate():
    ...
    transl = Translator()
    output = transl.translate(input , src = "vi", dest = "en"); 
    box1.insert(END,output.text)
